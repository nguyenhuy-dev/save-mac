        ...
        <div className="flex-1">
          ...
          <ul className="flex flex-col gap-3 text-[14px] leading-relaxed">
            <li className="flex items-start gap-2">
              ...
              <span><strong>Huy:</strong> Core Logic & Quản lý Git</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#D35400] mt-1">■</span> 
              <span><strong>Duy:</strong> Lập trình UI/UX</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#D35400] mt-1">■</span> 
              <span><strong>Trân:</strong> Xử lý Dữ liệu - Data</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#D35400] mt-1">■</span> 
              <span><strong>Lộc:</strong> Xây dựng Component</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#D35400] mt-1">■</span> 
              <span><strong>Tuấn:</strong> QA/QC & Deploy</span>
            </li>
          </ul>
        </div>
